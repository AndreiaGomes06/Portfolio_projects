...
# Set the PGPASSWORD environment variable to not ask for the password every time
subprocess_env = dict(PGPASSWORD=source_config['password'])

# Execute the dump command
subprocess.run(dump_command, env=subprocess_env, check=True)

# We need to get everithing from the source database over to the destination
